...
def conversionBinaria(individuo):
  ...
  for i in individuo:                   #Para cada individuo
    ...
    for j in x:                         #Para cada elemento de la lista x
      tamaño = 6 - len(j)               #Usamons un tamaño que ira variando
      ceros = list()                    #Lista para los ceros 0
      for k in range(tamaño):           #Segun el tamaño de agregan los ceros a la lista, estos estan en formato string
